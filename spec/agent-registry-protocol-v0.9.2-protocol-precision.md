---
layout: default
title: "ARPA v0.9.2 Protocol Precision"
nav_exclude: true
---

# ARPA v0.9.2 Protocol Precision

**Status:** Candidate Specification amendment  
**Applies to:** ARPA v0.9.0 Candidate Specification and v0.9.1 Adversarial Hardening  
**Version:** 0.9.2  
**Date:** 2026-09-18  
**License:** CC BY 4.0
...
This document is a normative precision amendment to the ARPA Candidate Specification. It resolves cross-artifact ambiguity exposed during preparation of the IETF `-01` revision. It does not broaden the ARPA architecture or add a new conformance target.
