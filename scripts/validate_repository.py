...
required=['README.md','LICENSE','LICENSE-CONTENT','LICENSE-CODE','licensing/artifact-license-policy.json','CHANGELOG.md','ROADMAP.md','GOVERNANCE.md','CONTRIBUTING.md','SECURITY.md','CODE_OF_CONDUCT.md','CITATION.cff','AI_USAGE.md','PROJECT-STATUS.yaml','schemas/project-status.schema.json','schemas/operational-resilience-declaration.schema.json','PORTFOLIO_STATUS.md','docs/index.md','docs/interoperability.md','docs/release-policy.md','spec/agent-registry-protocol-v0.9.0.md','spec/agent-registry-protocol-v0.10.0.md','docs/architecture/trqp-arpa-interoperability.md','docs/historical-authority-resolution.md','docs/operational-resilience.md','docs/candidate-specification-guide.md','docs/migration-v0.5.0-to-v0.9.0.md','RELEASE_NOTES_v0.9.0.md','RELEASE_NOTES_v0.9.2.md','RELEASE_NOTES_v0.9.4.md','RELEASE_NOTES_v0.9.5.md','RELEASE_NOTES_v0.10.0.md','docs/understand.md','docs/build.md','docs/assure.md','docs/operate.md','docs/integrate.md','docs/govern.md','spec/profiles/arpa-a2a-v1.0-interoperability-profile.md','mappings/a2a-v1.0-arpa-mapping.yaml','.github/workflows/validate.yml','.github/workflows/pages.yml','.github/workflows/release.yml','.github/ISSUE_TEMPLATE/bug_report.yml','.github/ISSUE_TEMPLATE/implementation_report.yml','.github/pull_request_template.md']
errors=[]
for rel in required:
...
try:
    ...
    expected={
        ...
        'specification_status':'candidate-specification',
    }
