...
validate:
	...
	python3 scripts/validate_authority_commitment_pp02.py
...
ietf-lint: ietf-build
	@if command -v rfclint >/dev/null 2>&1; then rfclint ietf/generated/draft-sankarshan-agent-registry-protocol-02.xml; else echo "rfclint unavailable; xml2rfc build validation completed"; fi

ietf-check: ietf-lint
	@grep -q "draft-sankarshan-agent-registry-protocol-02" ietf/generated/draft-sankarshan-agent-registry-protocol-02.txt
	@grep -q "Security Considerations" ietf/generated/draft-sankarshan-agent-registry-protocol-02.txt
	@grep -q "IANA Considerations" ietf/generated/draft-sankarshan-agent-registry-protocol-02.txt
	@grep -q "agentreg:<registry-namespace>:<agent-local-id>" ietf/generated/draft-sankarshan-agent-registry-protocol-02.txt
	@grep -q "Protocol Precision for Revision 01" ietf/generated/draft-sankarshan-agent-registry-protocol-02.txt
	@grep -q "Action-Specific Authority Evaluation" ietf/generated/draft-sankarshan-agent-registry-protocol-02.txt
	@grep -q "Relationship to Adjacent IETF Work" ietf/generated/draft-sankarshan-agent-registry-protocol-02.txt
...
pages-stage-ietf: pages-build ietf-check
	...
	cp ietf/generated/draft-sankarshan-agent-registry-protocol-02.xml _site/ietf/generated/
	cp ietf/generated/draft-sankarshan-agent-registry-protocol-02.txt _site/ietf/generated/
	cp ietf/generated/draft-sankarshan-agent-registry-protocol-02.html _site/ietf/generated/
	: > _site/ietf/generated/rfc-local.css
	sha256sum \
		_site/ietf/generated/draft-sankarshan-agent-registry-protocol-02.xml \
		_site/ietf/generated/draft-sankarshan-agent-registry-protocol-02.txt \
		_site/ietf/generated/draft-sankarshan-agent-registry-protocol-02.html \
		_site/ietf/generated/rfc-local.css \
